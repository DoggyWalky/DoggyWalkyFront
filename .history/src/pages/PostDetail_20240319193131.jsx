...
export default function PostDetail() {
  const animatedItem = useScrollFadeIn('left', 1, 0.2); //스크롤시 애니메이션
  ...
  return (
    <>
      ...
      <section className='flex flex-col md:flex-row px-4 mt-10 mb-20'>
        <div className='basis-8/12'>
          <img className=' w-full' src='/images/testPost.jpg' alt='test' />
        </div>
        <div
          className='w-full basis-5/12 flex flex-col p-4 text-text shadow-[0_3px_10px_rgb(0,0,0,0.2)]'
          {...animatedItem}
        >
