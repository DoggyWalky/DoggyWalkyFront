...
export default function ModifyPost() {
  ...
  return (
    <>
      <div className='relative top-28  font-bold text-xl  text-center '>
        <div className='text-text '>
          강아지의 <span className='text-red-400'>산책 친구</span>를 찾고
          계신가요?
          <br />
          함께 <span className='text-brand'>즐거운 시간</span>을 보낼 친구를
          기다리고 있어요!
        </div>
      </div>
      <section className='flex w-full h-screen  items-center justify-center'>
        <div className='flex w-3/6 h-4/6  justify-center bg-ExPost opacity-80 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'></div>
