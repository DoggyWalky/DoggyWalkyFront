...
export default function ModifyProfile() {
  return (
    ...
    <div>
      <div className='flex mt-28 w-11/12 h-4/6'>
        <div className='w-3/6 h-4/6 bg-ExPost bg-no-repeat opacity-80 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'>
          <img src='' alt='' className='w-3/6 h-4/6 bg-ExPost bg-no-repeat' />
        </div>
      </div>
    </div>
  );
