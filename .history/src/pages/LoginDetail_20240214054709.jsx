...
const LoginScroll = () => {
  ...
  const SocialLogin = () => {
    const NAVER_AUTH_URI = `http://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${process.env.REACT_APP_CLIENT_ID}&redirect_uri=${process.env.REACT_APP_REDIRECT_URL}&state=cosegu`;
        ...
        >
          ...
          <div className='text-2xl mt-10 '>
            ...
            <button
              ...
              className='py-1 px-8   border-2 border-black rounded-xl '
            >
              Login
            </button>
          </div>
