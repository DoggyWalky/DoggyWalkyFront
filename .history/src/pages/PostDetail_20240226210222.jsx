  ...
  return (
    <>
      ...
      <section className='flex flex-col md:flex-row px-4 my-10'>
        ...
        <div className='w-full basis-5/12 flex flex-col p-4 text-text'>
          <div className='flex'>
            <h2 className=' text-2xl font-medium pb-2'>
              뽀삐의 친구를 구합니다!
            </h2>
            <h3 className=' text-lg font-medium pb-2 text-gray-500 mb-5'>
              유가영
            </h3>
          </div>
          <div className='flex items-center font-medium text-base  mb-4'>
            <span className='mr-3'>강아지 분류 : </span>
            <select className='select max-w-xs text-base'>
              <option>소형견</option>
            </select>
          </div>
          <h3 className='flex gap-3 text-lg font-medium pb-2 text-gray-500 mb-5'>
            알바비 : <p className='text-lg font-bold text-red-500'> 10,000 </p>
            원
          </h3>
          <div className=' h-40 snap-y ... flex mb-10 overflow-y-auto p-4 shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'>
