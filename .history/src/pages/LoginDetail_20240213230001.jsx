...
export default function LoginDetail() {
  return (
    <div className='flex relative justify-center items-center mt-44 '>
      ...
      <login
        className='mr-64 box-shadow: 12px 13px 25px 3px rgba(0,0,0,0.72);
-webkit-box-shadow: 12px 13px 25px 3px rgba(0,0,0,0.72);
-moz-box-shadow: 12px 13px 25px 3px rgba(0,0,0,0.72);'
      >
