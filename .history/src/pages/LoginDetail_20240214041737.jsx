...
const LoginScroll = () => {
  ...
  const SocialLogin = () => {
    const NAVER_AUTH_URL = `http://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${process.env.4MhQd67NJONrPkqRDQd1}&redirect_uri=${process.env.mLHKLx27f}&state=cosegu`;
