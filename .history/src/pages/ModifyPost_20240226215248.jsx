...
export default function ModifyPost() {
  ...
  return (
    <>
      <div className='text-text  relative top-28 '>
        <h2 className='flex font-bold text-xl justify-center text-center '>
          <span>강아지 산책 친구</span>를 찾고 계신가요?
          <br />
          함께 즐거운 시간을 보낼 친구를 기다리고 있어요!
        </h2>
      </div>
