...
export default function LoginDetail() {
  return (
    <div className='flex relative justify-center items-center mt-32  py-20 bg-gradient-to-tl from-yellow-200 via-white to-cyan-200'>
      ...
      <div className='mr-64 p-4 border rounded-xl shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] bg-white rounded-xl'>
