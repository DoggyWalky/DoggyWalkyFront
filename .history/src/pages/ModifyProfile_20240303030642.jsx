...
export default function ModifyProfile() {
  return (
    <div className='grid mt-28 items-center '>
      <section className=''>
        <p className='font-bold text-3xl text-center mb-8'>프로필 수정하기</p>
        <div className='flex w-full h-screen  justify-center '>
          <div className='flex w-2/6 h-4/6  bg-ExPost bg-no-repeat opacity-80 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'>
