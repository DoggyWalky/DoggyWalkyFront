    ...
    <div>
      ...
      <div className='flex  border-t-2 border-gray-300 h-screen'>
        ...
        <div className='w-3/5  border-l-2 border-gray-300 '>
          ...
          <div className='flex items-center justify-cneter px-8 '>
            <textarea
              type='text'
              placeholder='메시지 입력...'
              className=' border border-black rounded-xl h-20 w-10/12 items-center placeholder:center'
            />
            <button className='border bg-lightYellow p-2 rounded-xl ml-5'>
              전송
            </button>
          </div>
        </div>
