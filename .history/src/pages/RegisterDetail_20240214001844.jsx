...
export default function RegisterDetail() {
  return (
    <div className='flex flex-col items-center mt-3 py-10 w-1/2 m-auto shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] rounded-xl'>
