...
const Introduce = () => {
  ...
  const animatedItem2 = useScrollFadeIn('left', 1, 0.2); // animatedItem2에 다른 지연 값을 부여
    ...
    <>
      <section className='py-20'>
        <div className='flex justify-between'>
          <div className='relative text-center top-36 ml-20' {...animatedItem2}>
            <ReactTyped
              strings={['DoggyWalky']}
              typeSpeed={80}
              loop={false}
      ...
      <section className='py-20'>
        <div className='flex justify-between'>
          ...
          <div className='relative text-center top-32 mr-16' {...animatedItem2}>
      ...
      <section className='py-40 flex justify-between' {...animatedItem1}>
