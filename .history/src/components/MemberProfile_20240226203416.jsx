...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative flex -top-24 z-10 w-2/4 h-12 items-center justify-center border-black border bg-white rounded-lg'>
        <div href='#divet' className=' w-1/2 items-center justify-cente '>
          등록된 강아지
        </div>
        <div href='#review ' className=' w-1/2 items-center justify-cente '>
          후기
        </div>
      </div>
