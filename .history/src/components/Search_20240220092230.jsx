      ...
      <section className=' relative'>
        ...
        <div className='relative h-96 -top-40 z-10 bg-gray-100 rounded-3xl'>
          <form
            ...
            {...animatedItem}
          >
            <div class='  flex  items-center border-b border-blue px-2 text-md '>
              ...
              <button
                class='flex-shrink-0 border-transparent border-4 text-blue hover:text-teal-800 text-md py-1 px-2 rounded'
                type='button'
              >
                Search
              </button>
