  ...
  return (
    <div>
      <div className='relative z-20 max-w-lg mx-auto'>
        <img className='rounded-md w-56 h-56 ' src='images/pet.jpg' alt='Pet' />
      </div>
      ...
      <div className='py-5 bg-gray-100 rounded-3xl '>
        <div className='ml-7'>
          <p className='font-bold text-2xl text-left mb-3 '>등록된 강아지</p>
