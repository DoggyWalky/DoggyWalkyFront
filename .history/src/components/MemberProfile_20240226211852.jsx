...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative flex -top-24 z-10 w-2/5 h-12 items-center mx-auto mb-32 shadow-2xl text-lg bg-white rounded-lg'>
        <button
          className=' w-1/2 text-center border-r-2 font-bold border-gray-300 hover:text-brand hover:drop-shadow-2xl hover:shadow-black'
          onClick={() => scrollToSection('section1')}
        >
          등록된 강아지
        </button>
        <button
          className=' w-1/2  text-center font-bold  hover:text-brand'
      ...
      <div id='section1' className='py-4 pt-48 mb-48'>
        <div className='ml-7'>
          <p className='font-bold text-4xl text-center mb-12 text-left'>
            등록된 강아지
          </p>
