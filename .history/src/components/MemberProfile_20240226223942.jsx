...
export default function MemberProfile() {
  return (
    <div>
      <div className=' p-4 pt-3 mb-16 items-center  bg-slate-100 rounded-3xl'>
      ...
      >
        <div className=' '>
          ...
          <div class='snap-x ... flex mb-10 p-10 mx-80  bg-white shadow-xl rounded-2xl overflow-x-auto'>
