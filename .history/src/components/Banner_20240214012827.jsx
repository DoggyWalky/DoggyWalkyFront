    ...
    <section className='relative left-1/2 transform -translate-x-1/2 w-screen  h-[800px] bg-yellow-900 '>
      ...
      <div className='absolute w-full bottom-32 text-center text-gray-50 drop-shadow-2xl'>
        ...
        <p className='text-2xl'>
          ...
          seamless and enjoyable experience for both parties. Our platform aims
          to address the needs of busy pet owners who may not always have the
          time to take their furry friends for a stroll, and the dog lovers who
          are eager to spend quality time with adorable companions.
        </p>
      </div>
    </section>
  );
