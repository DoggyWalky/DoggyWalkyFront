...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative flex -top-24 flex-grow divider divider-horizontal  z-10 w-2/5 h-12 items-center mx-auto mb-32 shadow-2xl text-lg bg-white rounded-lg'>
        <button
          className=' w-1/2 text-center  font-bold border-gray-300 hover:text-brand hover:scale-150'
          onClick={() => scrollToSection('section1')}
        >
          등록된 강아지
        </button>
        <div className='divider  flex-row h-full'></div>
        <button
