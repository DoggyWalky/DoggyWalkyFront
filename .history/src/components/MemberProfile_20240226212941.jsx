...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative flex -top-24 divider flex-row divider-horizontal  z-10 w-2/5 h-12 items-center mx-auto mb-32 shadow-2xl text-lg bg-white rounded-lg'>
        <button
