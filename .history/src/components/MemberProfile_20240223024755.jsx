  ...
  return (
    <div>
      ...
      <div className='relative h-auto -top-24 pb-10 bg-gray-100 rounded-3xl '>
        <section className='text-lg ml-8 pt-32'>
      ...
      <div className='relative  max-w-lg mx-auto'>
        <p className='font-bold text-3xl text-center mb-5'>등록된 강아지</p>
      </div>
      <div className='relative h-auto -top-24 pb-10 z-20 bg-gray-100 rounded-3xl '>
        <section className='text-lg ml-8 pt-32'>
          <div className='flex mb-3.5'>
            <p className='font-bold mr-5'>닉네임 :</p>
            <p>아 시츄키울껄</p>
