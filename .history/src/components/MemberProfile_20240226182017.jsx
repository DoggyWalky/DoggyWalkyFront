...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative -top-24 z-10 w-2/6 px-10 flex justify-between h-12 items-center border-black border bg-white rounded-lg'>
        <p href='#pet' className='border-r-2 border-black'>
          등록된 강아지
        </p>
        <p href='#review'>후기</p>
      </div>
