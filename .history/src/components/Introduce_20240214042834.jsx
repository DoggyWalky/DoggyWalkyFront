...
const Introduce = () => {
  ...
  return (
    <section className='relative left-1/2 transform -translate-x-1/2 w-screen ml-auto '>
      <section className=' flex justify-between items-center py-28 w-max_width mx-auto'>
      ...
      <section className='py-28 flex items-center justify-between  bg-lightYello1 w-max_width mx-auto'>
      ...
      <section className='py-28 flex items-center  justify-between w-max_width mx-auto'>
