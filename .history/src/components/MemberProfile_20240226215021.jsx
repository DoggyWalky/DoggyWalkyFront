...
export default function MemberProfile() {
  return (
    <div>
      <div className=' p-4 pt-3  items-center  bg-gray-200 rounded-3xl'>
      ...
      <div id='section1' className='py-4 pt-3 mb-48 '>
        <div className='ml-7'>
          <p className='font-bold text-4xl text-center mb-12 '>등록된 강아지</p>
