...
export default function MemberProfile() {
  return (
    <div className='w-full '>
      ...
      <div
        id='section1'
        className='pt-28 pb-40  bg-slate-100  mx-auto -translate-x-80'
      >
        <div className=' '>
          ...
          <div class='snap-x ... flex mb-10 p-10 mx-80 w-11/12 bg-white shadow-2xl rounded-2xl overflow-x-auto'>
