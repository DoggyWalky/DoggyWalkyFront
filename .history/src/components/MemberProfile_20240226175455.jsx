...
export default function MemberProfile() {
  return (
    <div>
      <div className=' p-4 pt-9 mb-10 items-center  bg-gray-200 rounded-3xl'>
        ...
        <div className='   w-11/12 items-center  text-lg  p-4'>
          <p className='text-xl font-bold   text-center'>아 시츄키울껄</p>
          <p className=''>
