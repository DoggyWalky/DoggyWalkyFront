...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div
        id='section1'
        className='pt-28 pb-56 w-screen bg-slate-100  mx-auto transform -translate-x-1/2'
      >
        <div className=' '>
          <p className='font-bold text-4xl text-center mb-16 '>등록된 강아지</p>
          <div class='snap-x ... flex mb-10 p-10 bg-slate-200 rounded-2xl overflow-x-auto'>
