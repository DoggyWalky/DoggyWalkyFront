  ...
  return (
    <div>
      ...
      <div className=' relative flex -top-24 z-10 w-2/5 h-12 items-center mx-auto shadow-2xl text-lg bg-white rounded-lg'>
        <div 
          className=' w-1/2 text-center border-r-2 border-gray-300 ' onClick={() => scrollToSection('section1')}
        >
          등록된 강아지
        </div>
        <div  className=' w-1/2  text-center' onClick={() => scrollToSection('section2')}>
          후기
        </div>
      </div>

      <div className='py-4  mb-6' id='section1'>
        <div className='ml-7'>
