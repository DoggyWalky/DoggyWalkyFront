...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative -top-24 z-10 w-2/6  flex  h-12 items-center border-black border bg-white rounded-lg'>
        <div
          href='#divet'
          className=' justify-center pr-4 border-r-2 border-black '
        >
          등록된 강아지
        </div>
