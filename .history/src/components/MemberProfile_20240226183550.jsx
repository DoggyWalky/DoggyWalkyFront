...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative -top-24 z-10 w-2/6  flex justify-center h-12 items-center border-black border bg-white rounded-lg'>
        <div href='#divet' className=' pr-4 border-r-2 border-black '>
          등록된 강아지
        </div>
        <div href='#review ' className=' pl-4 min-w-24 justify-center'>
          후기
        </div>
      </div>
