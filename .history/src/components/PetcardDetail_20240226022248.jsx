      ...
      <div className=' '>
        <div className=' text-lg  items-center justify-center'>
          ...
          <div className='bg-white rounded-lg max-w-lg'>
            <div className='flex'>
              <p className='px-5'>이름 :</p>
              <p className='w-5/6'>테리</p>
            </div>
            <div className='flex'>
              <p className='px-5'>분류 :</p>
              <p className='w-5/6'>대형견</p>
            </div>
            <div className='flex'>
              <p className='px-5'>몸무게 :</p>
              <p className='w-5/6'>45KG</p>
            </div>
            <div className='flex'>
              <p className='px-5'>소개 :</p>
              <p className='w-5/6'>
