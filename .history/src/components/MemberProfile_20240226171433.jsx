...
const handleNextButtonClick = (nextType: 'prev' | 'next') => {
  ...
  const scrollAmount = nextType === 'prev' ? -horizontalScrollRef.current.offsetWidth : horizontalScrollRef.current.offsetWidth;
    ...
    return (
      <div>
        <div className='flex mb-4 items-center'>
          ...
          <div className=' h-auto bg-gray-100 rounded-3xl w-3/4 ml-4 '>
            <section className='text-lg  p-4'>
              ...
              <div className='flex'>
                ...
                <p className='w-5/6'>
                  ...
                  걱정이 이만저만이 아닐 때가 많다는 거 공감합니다. 저희
                  아이들도 활동량이 장난이 아니라 저도 자연스레 체력이
                  늘어나더라구요. 그런 점에서 대형견들 산책을 수월하게 시킬 수
                  있지 않나 생각합니다. 많은 관심 부탁드려요~!
                </p>
              </div>
            </section>
          </div>
