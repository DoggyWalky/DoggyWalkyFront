...
export default function MemberProfile() {
  return (
    <div>
      ...
      <div className=' relative -top-24 z-10 w-2/6 px-20 flex justify-between h-12 items-center border-black border bg-white rounded-lg'>
        <div href='#divet' className=' m-4'>
          등록된 강아지
        </div>
