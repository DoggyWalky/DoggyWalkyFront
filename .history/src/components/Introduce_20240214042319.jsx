...
const Introduce = () => {
  ...
  return (
    <section className='relative left-1/2 transform -translate-x-1/2 w-screen ml-auto justify-center mx-auto'>
      ...
      <section
        className='py-28 flex items-center justify-between  bg-lightYello1
      '
      >
