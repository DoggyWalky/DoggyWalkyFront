...
//--------------강아지관련--------------
//강아지 조회
export async function getPet(dogId) {
  try {
...
//유저의 강아지 목록 조회
export async function getUserPet(ownerId) {
  try {
...
//게시글 조회
export async function getPost(searchCondition) {
  try {
...
//--------------후기 관련--------------
//후기 조회
export async function getReview(searchCondition) {
  try {
...
//후기 등록(평점 포함)
export async function registerFileReview() {
  try {
...
//--------------파일 관련--------------
//파일 리스트 조회
export async function gethFile() {
  try {
...
//채팅 상세 조회
export async function getChatDetail(chatroomId) {
  try {
...
//-----------GPS좌표 관련--------------
//gps좌표 조회
export async function getGps(boardId) {
  try {
